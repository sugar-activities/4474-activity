...
class SearchBoxMixin(object): # {{{
    ...
    def __init__(self):
        ...
        self.search_highlight_only.setChecked(dynamic.get('search_highlight_only', False))
...
class SavedSearchBoxMixin(object): # {{{
    ...
    def __init__(self):
        ...
        self.saved_search.initialize(self.search, colorize=True, help_text=_('Saved Searches'))
