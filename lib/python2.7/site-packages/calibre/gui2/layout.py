...
class SearchBar(QWidget): # {{{
    ...
    def __init__(self, parent):
        ...
        caja1.addWidget(self.search_button)
        ...
        #l.addWidget(x)
        caja1.addWidget(x)
        x.setToolTip(_("Reset Quick Search"))# cruz cancel-reset
...
class ToolBar(QToolBar): # {{{
    ...
    def apply_settings(self):
        ...
        sz = {'small':24, 'medium':32, 'large':64}[sz]
...
class MainWindowMixin(object): # {{{
    ...
    def __init__(self, db):
        ...
        self.tool_bar = ToolBar(self.donate_button, self.location_manager, self.child_bar, self)
